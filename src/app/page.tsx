                      ...
                      <div className="space-y-3">
                        {business.whatsappNumber && (
                          <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300 group">
                            <div className="flex items-center justify-center w-8 h-8 bg-emerald-100 dark:bg-emerald-900/30 rounded-lg group-hover:bg-emerald-200 dark:group-hover:bg-emerald-800/50 transition-colors">
                              <svg
                            ...
                            <div className="flex-1 flex items-center gap-2 flex-wrap">
                              <a
                                href={
                                  ...
                                  `https://wa.me/${business.whatsappNumber.replace(
                                    /\D/g,
                                    ""
                                  )}`
                                }
                              ...
                              <span
                                className="px-2 py-0.5 rounded-full text-[10px] font-semibold uppercase tracking-wide bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-300"
                                title="Which signal found this number"
                              >
                                {business.whatsappSource}
                              </span>
                            </div>
                          </div>
                        )}
